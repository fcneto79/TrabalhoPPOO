...
public class Cenario3 extends Cenario {
  ...
  protected int criarFantasma () {
    ...
    int candidatosFantasma[] = {1,2,3,4,5};
  ...
  protected void definirSaidas () {
    ...
    ambientes.get(0).adicionarSaidas(
      ambientes.get(1), ambientes.get(3), ambientes.get(2), ambientes.get(4)
    );

    ambientes.get(1).adicionarSaidas(
      null, ambientes.get(0), null, null
    );

    ambientes.get(2).adicionarSaidas(
      null, ambientes.get(6), null, ambientes.get(0)
    );

    ambientes.get(3).adicionarSaidas(
      ambientes.get(0), ambientes.get(5), ambientes.get(6), null
    );
    ...
    ambientes.get(5).adicionarSaidas(
      ambientes.get(3), null, null, null
    );
  }
