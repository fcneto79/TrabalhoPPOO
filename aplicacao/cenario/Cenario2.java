...
public class Cenario2 extends Cenario {
  ...
  protected int criarFantasma () {
    ...
    int candidatosFantasma[] = {1,3,4,5};
  ...
  protected void definirSaidas () {
    ...
    ambientes.get(0).adicionarSaidas(
      ambientes.get(3), null, ambientes.get(2), ambientes.get(1)
    );

    ambientes.get(1).adicionarSaidas(
      null, null, ambientes.get(0), null
    );

    ambientes.get(2).adicionarSaidas(
      ambientes.get(4), ambientes.get(5), ambientes.get(6), ambientes.get(0)
    );

    ambientes.get(3).adicionarSaidas(
      null, ambientes.get(0), ambientes.get(4), null
    );

    ambientes.get(4).adicionarSaidas(
      null, ambientes.get(2), null, ambientes.get(3)
    );

    ambientes.get(5).adicionarSaidas(
      ambientes.get(2), null, null, null
    );
  }
